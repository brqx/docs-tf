...
# creating IAM Policy SQS-unacola-eu-west-1-cola_policy: MalformedPolicyDocument: Statement IDs (SID) must be alpha-numeric. Check that your input satisfies the regular expression [0-9A-Za-z]*
variable "sqs_sid_name" {
  description = "Nombre del SID para la cola SQS a usar"
  default     = "SIDSQSCOLA"
}
