...
resource "aws_iam_policy" "bucket_policy" {
  ...
  path        = "/"
  description = "Allow "
  policy = data.template_file.s3_read_write_access_policy_template.rendered
}
...
# Se relaciona con el rol y es lo que vamos a usar para decirle a la instancia de EC2 que use este rol
